...
- Улучшенная безопасность. Если злоумышленник взломает один из сайтов на сервере, он не сможет получить досуп к другим сайтам. Таким образом, можно на одном сервере с новыми и важными проектами хранить устаревшие проекты и не обновлять их.
...
- Активное тестирование решения в продакшен-окружении.
...
- Полезный инструментарий для современной разработки, которым мало кто пользуется в Битрикс, но который повышает качество и скорость разработки:
